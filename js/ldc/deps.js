...
goog.addDependency('../../../ldc/aikuma/elantranscript.js', ['ldc.aikuma.ElanTranscript'], []);
goog.addDependency('../../../ldc/aikuma/events.js', ['ldc.aikuma.SwimLaneRegionEvent'], ['ldc.event.Event']);
goog.addDependency('../../../ldc/aikuma/index.js', ['ldc.aikuma'], ['ldc.aikuma.AikumaFolder', 'ldc.aikuma.AikumaSegment', 'ldc.aikuma.AikumaTranscript', 'ldc.aikuma.ElanTranscript', 'ldc.aikuma.SwimLane', 'ldc.aikuma.SwimLaneRegionEvent', 'ldc.aikuma.SwimLaneStack']);
...
goog.addDependency('../../../ldc/aikuma/swimlanestack.js', ['ldc.aikuma.SwimLaneStack'], ['ldc.datamodel.TableAddRowEvent', 'ldc.datamodel.TableDeleteRowEvent', 'ldc.datamodel.TableUpdateRowEvent']);
...
goog.addDependency('../../../ldc/fileformat/index.js', ['ldc.fileformat'], ['ldc.fileformat.FileFormat']);
goog.addDependency('../../../ldc/index.js', ['ldc'], ['ldc.aikuma', 'ldc.datamodel', 'ldc.event', 'ldc.mediaplayer', 'ldc.textdisplay', 'ldc.utils', 'ldc.waveform']);
goog.addDependency('../../../ldc/mediaplayer/audioplayer.js', ['ldc.mediaplayer.AudioPlayer'], ['ldc.event.Signal']);
...
goog.addDependency('../../../ldc/textdisplay/textedit.js', ['ldc.textdisplay.TextEdit'], ['goog.dom', 'goog.events', 'ldc.datamodel.TableRow', 'ldc.event.Event', 'ldc.waveform.WaveformSelectEvent']);
goog.addDependency('../../../ldc/utils/color.js', ['ldc.utils.Color'], []);
goog.addDependency('../../../ldc/utils/colorcode.js', ['ldc.utils.ColorCode'], []);
goog.addDependency('../../../ldc/utils/colorseries.js', ['ldc.utils.ColorSeries'], []);
goog.addDependency('../../../ldc/utils/index.js', ['ldc.utils'], ['ldc.utils.Color', 'ldc.utils.ColorCode', 'ldc.utils.ColorSeries']);
